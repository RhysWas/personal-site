...
export default function Home() {
  ...
  return (
    <div className="gradient-radial bg-stone-200 min-h-screen flex items-center justify-center">
      <div className="w-2/3 p-8 text-center  border-double border-orange-400 border-8">
        <div className="text-9xl text-left font-extrabold mb-4">
        ...
        <p className="text-gray-700 text-2xl mb-6">{description}</p>
        <p className="text-gray-600">Welcome to my portfolio website. I am passionate about creating innovative web solutions.</p>
