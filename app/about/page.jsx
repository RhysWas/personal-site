        ...
        <div className="items-center md:items-start">
          ...
          <div className="m-auto place-self-center md:pl-8">
            <p className="text-gray-800 md:text-lg text-center mb-4">
              Hi, I am Rhys Wastell, a passionate programmer, developer based in
              Ann Arbor. I recently graduated from the University of Michigan,
              and am currently working as a Junior Fullstack developer at Gordon
              Food Service.
            </p>
          </div>
        </div>
        <div className="h-1 w-full bg-gradient-to-r from-cyan-400 to-orange-400 my-8 rounded" />
        <div className="mt-8">
